 ...
 *
 * Вывести в шаблоне: do_action('custom_breadcrumb');
 *
 */
class Custom_Breadcrumb
{
	...
	{
		add_action('custom_breadcrumb', [$this, 'render']);
	}
	...
	function modify_yoast_output($html)
	{
		...
		$ul = '<div class="breadcrumbs"><div class="container"><div class="row"><ul class="col-lg-12" itemscope="itemscope" itemtype="https://schema.org/BreadcrumbList" class="breadcrumb">%s</ul></div></div></div>';
